        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('AdminAssets/dist/img/ahmed.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Ahmed Mohamed</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.firstPage.edit') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.skill.category.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.portfolio.category.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.partenr.index') }}" class="nav-link">
